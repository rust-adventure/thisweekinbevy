...
pub fn App() -> impl IntoView {
    ...
    view! {
        ...
        <Link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css?family=Archivo%20Black"
        />
        ...
        <Wrapper>
                <Routes>
                    ...
                    <ProtectedRoute
                      ...
                      redirect_path="/login"
                      condition=|| {
                        use_context::<Option<Username>>().flatten() == Some(Username("ChristopherBiscardi".to_string()))
                      }
                      view=AdminWrapper
                    >
                      <Route
                      ...
                      <Route
                        path="/issue"
                        view=admin::issues::Issues
                      />
                      <Route
                        path="/issue/:id"
                        view=admin::issue::Issue
                      />
                      <Route
                        path="/showcase"
                        view=admin::Showcase
