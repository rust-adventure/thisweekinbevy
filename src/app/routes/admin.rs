        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <ul role="list" class="mt-6 grid grid-cols-1 gap-6 border-b border-t border-gray-200 py-6 sm:grid-cols-2">
                ...
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50">
                    ...
                    <p class="mt-1 text-sm text-gray-500">"Showcases show off what the community is doing with Bevy."</p>
                    </div>
                </div>
                </li>
                <li class="flow-root">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50">
                    ...
                    <p class="mt-1 text-sm text-gray-500">"Crate Releases can be automated, but sometimes there's new updates."</p>
                    </div>
                </div>
                </li>
                <li class="flow-root">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50">
                    ...
                    <p class="mt-1 text-sm text-gray-500">"Devlogs track what the community is building over a longer series of time."</p>
                    </div>
                </div>
                </li>
                <li class="flow-root">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50">
                    ...
                    <p class="mt-1 text-sm text-gray-500">"Educationals teach people how to do things with Bevy."</p>
                    </div>
                </div>
                </li>
            </ul>
            <div class="mt-4 flex">
                <a href="/admin/issue" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">
...
pub fn AdminWrapper() -> impl IntoView {
    view! {
      ...
      <ul role="list" class="flex min-w-full flex-none gap-x-6 px-4 text-sm font-semibold leading-6 text-gray-600 sm:px-6 lg:px-8">
        <li>
          <A href="/admin" exact=true active_class="text-blue-600">Home</A>
        </li>
        <li>
          <A href="/admin/issue" exact=true active_class="text-blue-600">Issue</A>
        </li>
        <li>
          <A href="/admin/showcase" exact=true active_class="text-blue-600">Showcase</A>
        </li>
        <li>
          <A href="/admin/crate_release" exact=true active_class="text-blue-600">Crate Release</A>
        </li>
        <li>
          <A href="/admin/devlog" exact=true active_class="text-blue-600">Devlog</A>
        </li>
        <li>
          <A href="/admin/educational" active_class="text-blue-600">Educational</A>
        </li>
      </ul>
    </nav>
      </header>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            >
                <div class="relative rounded-md rounded-b-none px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-gray-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-indigo-600">
                    ...
                    <input required type="text" name="title" id="title" class="block w-full border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Hexagon procedural generation"/>
                </div>
                <div class="relative px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-gray-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-indigo-600">
                    <label for="url" class="block text-xs font-medium text-gray-900">URL</label>
                    <input required type="text" name="url" id="url" class="block w-full border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="https"/>
                </div>
                ...
                <label for="discord_url" class="block text-xs font-medium text-gray-900">Discord URL</label>
                <input type="text" name="discord_url" id="discord_url" class="block w-full border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="https"/>
            </div>
            <label required for="posted_date" class="block text-sm font-medium leading-6 text-gray-900">Posted At</label>
            <div class="mt-2">
                <input type="date" id="posted_date" name="posted_date" min="2024-01-01" />
            </div>
            <label required for="description" class="block text-sm font-medium leading-6 text-gray-900">Add your description (markdown compatible)</label>
            <div class="mt-2">
